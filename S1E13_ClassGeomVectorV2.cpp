...
private:
	// Приватная секция. Поля, определённые в этой секции, доступны только методам этого класса.
	int x;
	int y;
};
...
void main_ClassGeomVectorV2()
{
	...
	// Так не скомпилируется, так как поле x находится в приватной секции класса CGeomVectorV2.
	// v1.x = 10;
